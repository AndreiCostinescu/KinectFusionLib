...
namespace KinectFusion {
    ...
    public:
         ...
         */
        Pipeline(CameraParameters _camera_parameters, GlobalConfiguration const &_configuration);
    ...
    namespace internal {
        ...
        FrameData surface_measurement(const cv::Mat_<float> &input_frame,
                                      ...
                                      int kernel_size, float color_sigma, float spatial_sigma);
        ...
        namespace cuda {
            ...
            PointCloud extract_points(const VolumeData &volume, int buffer_size);

            SurfaceMesh marching_cubes(const VolumeData &volume, int triangles_buffer_size);
        }
